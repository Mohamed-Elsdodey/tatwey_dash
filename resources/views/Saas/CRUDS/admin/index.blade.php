...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">ادراين المدرسة
            {{$school->name}}
            </h5>
                ...
                <div>
                    <button id="addBtn-p" data-id="{{$school->id}}" class="btn btn-primary">اضافة اداري</button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> اداري </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'school_admins'])
    ...
    <script>
        $(document).on('click','#addBtn-p',function (){
            ...
            setTimeout(function (){
                $('#form-load').load("{{route("school_admins.create")}}?school_id="+school_id)
            },1000)
        })
    </script>
