@extends('Saas.Auth.layouts.inc.app')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center mt-sm-5 mb-4 text-white-50">
                    <div>
                        <a href="{{route('saas.index')}}" class="d-inline-block auth-logo">
                            <img src="{{get_file($settings->logo_header)}}" alt="" height="100">
                        </a>
                    </div>
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card mt-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="p-2 mt-4">
                            <form action="{{route('saas.postLogin')}}" method="post" enctype="multipart/form" id="Form">
                                @csrf
                                <div class="mb-3">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 200) {
                        ...
                        window.setTimeout(function () {
                            window.location = "{{route('saas.index')}}"
                        }, 1000);
