<form action="{{route('saas_profile.update',$saas->id)}}" method="post" id="EditForm">
    @csrf
    @method("PUT")
    ...
    <div class="row g-4">
        ...
        <div class="form-group">
            ...
            <input type="file" class="dropify" name="image" data-default-file="{{get_file($saas->image)}}" accept="image/*"/>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" required class="form-control form-control-solid" placeholder="{{trans('admin.name')}}"  name="name" value="{{$saas->name}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="email" required class="form-control form-control-solid"  placeholder=" {{trans('admin.email')}}" name="email" value="{{$saas->email}}"/>
        </div>
