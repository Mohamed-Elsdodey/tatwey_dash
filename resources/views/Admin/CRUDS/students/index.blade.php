...
@section('content')
    <div class="card AE_card">  
        <div class="card-header d-flex align-items-center">
            ...
            <div>
                <button id="addBtn-p" data-id="{{$room->id}}" class="btn btn-primary">اضافة طالب</button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> طالب </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    <script>
        var columns = [
            ...
            {data: 'positive_point', name: 'positive_point'},
            {data: 'negative_point', name: 'negative_point'},
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'students'])
    <script>
        $(document).on('click', '#addBtn-p', function () {
            var room_id=$(this).attr('data-id');
            var link="{{route('students.create')}}?room_id="+room_id;
