        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> صف دراسي </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'rows'])
    ...
    <script>
        $(document).on('click', '.importantStudent', function () {
            ...
            var routing="{{route('admin.importRowStudent',':id')}}";
            routing=routing.replace(':id',row_id)
